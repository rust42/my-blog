const FooterView = () => {
    ...
    return <footer className="footer text-center py-2 theme-bg-dark">
            ©{year}, Sandeep Koirala. All rights reserved.
            ...
            </svg> by <a href="https://themes.3rdwavemedia.com/" target="_blank" rel="noreferrer">Xiaoying Riley</a> for developers</small>
